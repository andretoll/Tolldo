...
{
    /// <summary>
    /// Extension that makes the MouseUp event the selector in lists rather than MouseDown.
    /// </summary>
    public static class ListSelectBehaviorExtension
    {
        public static readonly DependencyProperty ShouldSelectItemOnMouseUpProperty =
            DependencyProperty.RegisterAttached(
                "ShouldSelectItemOnMouseUp", typeof(bool), typeof(ListSelectBehaviorExtension),
